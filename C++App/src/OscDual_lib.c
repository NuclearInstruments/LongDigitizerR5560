...
//-
//- Take as input the downloaded buffer and decode the the different track for each channels. Channel order is the following: [0...16383] Channel 1, [16384...32767] Channel2
//- 
//- 
//-
//- ARGUMENTS:
...
for(int n=0; n< n_ch/2; n++)
{
	...
	if (current > 0)
    {
        ...
        {
		 read_analog[k + (n_samples*(n*2+0))] = data_osc[i + (n_samples*n)] & 0x3FFF;
		 read_analog[k + (n_samples*(n*2+1))] = (data_osc[i + (n_samples*n)]>>14) & 0x3FFF;
